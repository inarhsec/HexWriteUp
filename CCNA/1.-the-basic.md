...
#### <mark style="color:blue;">RAM (Random Access Memory)</mark>
...
#### <mark style="color:blue;">**LPDDR**</mark> <a href="#lpddr" id="lpddr"></a>
...
* It was first cable in industry to transfer data from **Hard Drive** to [#ram-random-access-memory](1.-the-basic.md#ram-random-access-memory "mention")**RAM (**&#x75;p to 1GB)
